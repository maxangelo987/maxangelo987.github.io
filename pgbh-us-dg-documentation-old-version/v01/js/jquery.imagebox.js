...
(function($) {
  $.fn.imageBox = function(options) {
    ...
    $(objClicked).on("click", function() {
      ...
      $("#img-preview").html(
        '<img src="' +
          _url +
          '" width="500px" height="350px" class="image-box" style="cursor: move;"></img>'
      );
  ...
  function initHtml(obj) {
    var div = $(
      '<div id="unbind-pos" class="modal fade" style="display:none;" aria-hidden="true"></div>'
    );
    div.append(
